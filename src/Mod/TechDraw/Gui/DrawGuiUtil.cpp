...
Base::Vector3d DrawGuiUtil::fromSceneCoords(const Base::Vector3d& sceneCoord)
{
...
Base::Vector3d DrawGuiUtil::toSceneCoords(const Base::Vector3d& pageCoord)
{
    return Rez::guiX(DU::invertY(pageCoord));
}
