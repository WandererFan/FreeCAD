...
public:
    Module() : Py::ExtensionModule<Module>("Measure")
    {
        add_varargs_method("geLocatedTopoShape", &Module::getLocatedTopoShape,
            "Part.TopoShape = LinkCrawler.getLocatedTopoShape(DocumentObject, longSubElement) Resolves the actual placement of DocumentObject and applies it to a subelement."
        );
...
private:
    ...
    Py::Object getLocatedTopoShape(const Py::Tuple& args)
    {
        ...
        auto temp = LinkCrawler::getLocatedShape(*rootObject, leafSub);
